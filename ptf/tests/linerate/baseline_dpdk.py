...
ACCESS_N3_IP = IPv4Address('198.18.0.1')
CORE_N3_IP = IPv4Address('198.19.0.1')

ACCESS_ENB_IP = IPv4Address('198.18.0.2')
CORE_ENB_IP = IPv4Address('198.19.0.2')
    ...
    def runTest(self):
        ...
        for i in range(UE_COUNT):
            ...
            farDown = self.createFAR(
                ...
                dstIntf = DST_ACCESS,
                tunnelType = 0x1,
                tunnelIP4Src = int(ACCESS_N3_IP),
                tunnelIP4Dst = int(PDN_IP), # only one eNB to send to downlink
                tunnelTEID = 0,
...
class UplinkPerformanceBaselineTest(TrexTest, GrpcTest):
    ...
    def runTest(self):
        ...
        gtpu_pkt = pkt_add_gtpu(
            pkt=pkt,
            out_ipv4_src=str(ACCESS_ENB_IP),
            out_ipv4_dst=str(ACCESS_N3_IP),
            teid=1,
        )
